...
- **NEW NEW** API testing is now available!!!
...
4. There are demo tests when you open ExlJS, you can run and learn from them
### Notice Remember to enable macros in excel files in order for magic hotkey to work!
<!--
